...
const addResume = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, user, "Resume added successfully")
    );
});
...
const getUserResumes= asyncHandler(async(req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user.resumes, "resume fetched successfully"))
});
